...
var PassportAuthentification_1 = __importDefault(require("./Model/PassportAuthentification"));
var app = express_1.default();
var cors = require('cors');
var port = 8080;
var database = DatabaseClass_1.default.CreateObject();
//middleware
...
PassportAuthentification_1.default(passport_1.default);
// URL-encoded bodies (as sent by HTML forms)
app.use(express_1.default.urlencoded());
// Parse JSON bodies (as sent by API clients)
app.use(express_1.default.json());
//serveur
function ServeurLaunch() {
